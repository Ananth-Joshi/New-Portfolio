      ...
      <aside className="w-64 bg-zinc-900 border-r border-zinc-800 hidden md:flex flex-col shadow-xl z-10 relative">
        ...
        <div className="p-4 border-t border-zinc-800/60 bg-zinc-950/20">
          ...
          <form action="/auth/signout" method="post">
            <button type="submit" className="flex items-center cursor-pointer gap-3 w-full px-3 py-2 text-zinc-400 hover:text-white hover:bg-red-500/10 hover:text-red-400 rounded-lg transition-all group text-sm font-medium">
