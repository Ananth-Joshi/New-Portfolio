      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 p-8 md:p-12">
        ...
        <div className="w-full lg:w-3/5">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-serif text-4xl md:text-5xl tracking-tight mb-8">About Me</h2>
            <div className="text-lg md:text-xl text-white/70 leading-relaxed space-y-6">
              <p>
                I&apos;m a software engineer who cares deeply about the intersection of technical performance and user experience. I believe that the best code is the code you never have to think about, powering interfaces that feel completely natural.
              </p>
              <p>
