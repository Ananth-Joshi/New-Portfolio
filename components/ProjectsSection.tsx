    ...
    <section id="projects" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          return (
            ...
            >
              ...
              <div className="w-full lg:w-3/5 group">
                <div className={`relative w-full aspect-[4/3] sm:aspect-[16/10] overflow-hidden rounded-2xl ${project.color || 'bg-white/5'}`}>
                  <motion.div 
              ...
              <div className="w-full lg:w-2/5 flex flex-col items-start px-4 lg:px-8">
                <span className="text-4xl font-serif text-white/20 mb-4">{project.id}</span>
      ...
      <div className="mt-40 border-t border-white/10 pt-20">
        <div className="flex flex-col md:flex-row justify-between items-baseline mb-12">
          ...
          <Link href="/projects" className="text-sm font-medium hover:text-accent-purple transition-colors flex items-center gap-1 group">
            View archive
            <span className="group-hover:translate-x-1 transition-transform inline-block">→</span>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {otherProjects.map((project, i) => (
            <div key={i} className="p-8 bg-white/5 border border-white/10 rounded-2xl hover:shadow-lg transition-shadow group">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-2 text-xs text-white/50 font-medium">
                {project.technologies.map(tech => (
